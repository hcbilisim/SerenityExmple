using MyRepository = SerenityExmple.Administration.Repositories.UserPermissionRepository;
using MyRow = SerenityExmple.Administration.UserPermissionRow;

namespace SerenityExmple.Administration.Endpoints;
